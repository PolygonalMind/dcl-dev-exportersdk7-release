...
public class GlTF_Accessor : GlTF_Writer {
	...
	void WriteMin()
	{
		if (componentType == ComponentType.FLOAT)
		{
			...
			{
				case Type.SCALAR:
					jsonWriter.Write (SceneTraverserUtils.FloatToString(minFloat.x));
				break;

				case Type.VEC2:
					jsonWriter.Write (SceneTraverserUtils.FloatToString(minFloat.x) + ", " + SceneTraverserUtils.FloatToString(minFloat.y));
				break;

				case Type.VEC3:
					jsonWriter.Write (SceneTraverserUtils.FloatToString(minFloat.x) + ", " + SceneTraverserUtils.FloatToString(minFloat.y) + ", " + SceneTraverserUtils.FloatToString(minFloat.z));
				break;

				case Type.VEC4:
					jsonWriter.Write (SceneTraverserUtils.FloatToString(minFloat.x) + ", " + SceneTraverserUtils.FloatToString(minFloat.y) + ", " + SceneTraverserUtils.FloatToString(minFloat.z) + ", " + SceneTraverserUtils.FloatToString(minFloat.w));
				break;
				case Type.MAT4:
					for (int i = 0; i < 15; ++i)
					{
						jsonWriter.Write(SceneTraverserUtils.FloatToString(minMatrix[i]) + ", ");
					}
					jsonWriter.Write(SceneTraverserUtils.FloatToString(minMatrix[15]));
				break;
			}
		}
	...
	void WriteMax()
	{
		if (componentType == ComponentType.FLOAT)
		{
			...
			{
			case Type.SCALAR:
				jsonWriter.Write (SceneTraverserUtils.FloatToString(maxFloat.x));
				break;

			case Type.VEC2:
				jsonWriter.Write (SceneTraverserUtils.FloatToString(maxFloat.x) + ", " + SceneTraverserUtils.FloatToString(maxFloat.y));
				break;

			case Type.VEC3:
				jsonWriter.Write (SceneTraverserUtils.FloatToString(maxFloat.x) + ", " + SceneTraverserUtils.FloatToString(maxFloat.y) + ", " + SceneTraverserUtils.FloatToString(maxFloat.z));
				break;

			case Type.VEC4:
				jsonWriter.Write (SceneTraverserUtils.FloatToString(maxFloat.x) + ", " + SceneTraverserUtils.FloatToString(maxFloat.y) + ", " + SceneTraverserUtils.FloatToString(maxFloat.z) + ", " + SceneTraverserUtils.FloatToString(maxFloat.w));
				break;
		   case Type.MAT4:
				for(int i=0; i < 15; ++i)
				{
					jsonWriter.Write(SceneTraverserUtils.FloatToString(maxMatrix[i]) + ", ");
				}
				jsonWriter.Write(SceneTraverserUtils.FloatToString(maxMatrix[15]));
				break;
			}
		}
		else if (componentType == ComponentType.USHORT || componentType == ComponentType.UNSIGNED_INT)
